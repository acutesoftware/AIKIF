...
def document_programs():
    ...
    p.add('program.py', 'test program')
    p.add('fileMapping.py', 'uses ontology to get list of files to save data')
    p.add('index.py', 'rebuilds indexes')
...
def list_all_python_programs():
    """
    List all python programs
    """
    allPython = mod_prg.Programs('All Python Programs', 'T:\\user\\dev\\src\\python\\AIKIF\\aikif')
    tot_lines = 0
    tot_bytes = 0
    tot_files = 0
    tot_loc = 0
